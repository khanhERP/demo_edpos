...
export default function SalesOrders() {
  ...
  useEffect(() => {
    ...
    const handleEInvoiceModalClosed = async (event: CustomEvent) => {
      ...
      queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices"] });
      ...
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices"] }),
        queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables"] }),
        ...
        queryClient.refetchQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices"] }),
      ]);
  ...
  useEffect(() => {
    const handleNewOrder = () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] });
      queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices"] });
      queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/transactions"] });
      queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/date-range"] });
      queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices/date-range"] });
    };
  ...
  const { data: customers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/customers");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: [
      "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/list",
      startDate,
      endDate,
      customerSearch,
      orderNumberSearch,
    ...
    queryFn: async () => {
      try {
        ...
        const url = `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/list?${params.toString()}`;
  ...
  const { data: productsPaging } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/products");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: tables = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", selectedInvoice?.id],
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest(
          "GET",
          `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items/${selectedInvoice.id}`,
        );
  ...
  const updateOrderMutation = useMutation({
    mutationFn: async (updatedOrder: Order) => {
      ...
      const response = await apiRequest(
        "PUT",
        `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/${updatedOrder.id}`,
        updatePayload,
      );
    ...
    onSuccess: async (data, updatedOrder) => {
      ...
      queryClient.removeQueries({
        queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", updatedOrder.id],
      });
  ...
  const publishRequestMutation = useMutation({
    mutationFn: async (invoiceData: any) => {
      const response = await apiRequest(
        "POST",
        "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/einvoice/publish",
        invoiceData,
      );
      return response.json();
    },
      ...
      if (result.success && selectedInvoice) {
        try {
          ...
          const updateResponse = await apiRequest(
            "PUT",
            `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/${selectedInvoice.id}`,
            updateData,
          );
          console.log(
          ...
          queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] });
          queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/list"] });
          queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items"] });
          queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/invoices"] });
          ...
          await Promise.all([
            queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] }),
            queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/list"] }),
            queryClient.refetchQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] }),
            queryClient.refetchQueries({
              queryKey: [
                "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/list",
  ...
  const cancelOrderMutation = useMutation({
    ...
    onSuccess: async (data, orderId) => {
      ...
      if (selectedInvoice?.tableId) {
        try {
          ...
          if (!otherActiveOrders || otherActiveOrders.length === 0) {
            ...
            await apiRequest(
              "PUT",
              `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables/${selectedInvoice.tableId}/status`,
              {
                status: "available",
              },
            );
      ...
      // Clear cache completely and force fresh fetch
      queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] });
      queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/date-range"] });
      ...
      await Promise.all([
        ...
        queryClient.refetchQueries({
          queryKey: [
            "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-range",
            startDate,
            endDate,
            currentPage,
            itemsPerPage,
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      for (const item of itemsToCreate) {
        ...
        const response = await apiRequest(
          "POST",
          `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items/${editableInvoice.id}`,
          payload,
        );
      ...
      queryClient.removeQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items"] });
      queryClient.removeQueries({
        queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/date-range"],
      });

      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders"] }),
        queryClient.invalidateQueries({
          queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", editableInvoice.id],
        }),
        queryClient.invalidateQueries({
          queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/date-range"],
        }),
  ...
  const handlePayment = async (order: Invoice) => {
    ...
    try {
      const updateResponse = await apiRequest(
        "PUT",
        `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/${order.id}`,
        {
          paymentStatus: "paid",
          status: "paid",
  ...
  const handlePrintReceipt = async (order: any) => {
    try {
      ...
      const response = await apiRequest("GET", `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items/${order.id}`);
