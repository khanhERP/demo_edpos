...
export function TableGrid({ onTableSelect, selectedTableId }: TableGridProps) {
  ...
  const {
    ...
    queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", selectedOrder?.id || "none"],
  ...
  const transferTableMutation = useMutation({
    mutationFn: async ({
      ...
      const orderUpdateResponse = await apiRequest(
        "PUT",
        `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/${orderId}`,
        {
          tableId: newTableId,
        },
      );
      ...
      try {
        await apiRequest("PUT", `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables/${newTableId}/status`, {
          status: "occupied",
        });
      ...
      if (oldTableId) {
        try {
          ...
          const freshOrdersResponse = await apiRequest("GET", `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders`);
          ...
          if (!otherActiveOrders || otherActiveOrders.length === 0) {
            await apiRequest("PUT", `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables/${oldTableId}/status`, {
              status: "available",
            });
    ...
    onSuccess: async (data) => {
      ...
      try {
        ...
        const [freshTables, freshOrders] = await Promise.all([
          fetch(`https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables?${params}`).then((r) => r.json()),
          fetch(`https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders?${params}`).then((r) => r.json()),
        ]);
    ...
    try {
      ...
      if (currentOrderId) {
        try {
          const response = await apiRequest(
            "GET",
            `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items/${currentOrderId}`,
          );
  ...
  const splitOrderMutation = useMutation({
    mutationFn: async (splitData: {
      ...
      const response = await apiRequest("POST", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/split", {
      ...
      await Promise.all([
        ...
        refetchTables(),
        queryClient.invalidateQueries({
          queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", splitData.originalOrderId],
        }),
      ]);
  ...
  const handleSplitOrder = async (splitData: any) => {
    try {
      ...
      const response = await apiRequest("POST", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/split", splitData);
      ...
      <OrderDialog
        ...
        onOpenChange={(open) => {
          ...
          if (!open && editingOrder) {
            ...
            queryClient.invalidateQueries({ queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables"] });
            queryClient.invalidateQueries({
              queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/order-items", editingOrder.id],
            });
