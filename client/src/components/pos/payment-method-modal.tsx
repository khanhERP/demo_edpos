...
export function PaymentMethodModal({
  ...
  const { data: paymentMethodsData } = useQuery({
    queryKey: ["https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/payment-methods/active"],
    queryFn: async () => {
      const response = await apiRequest("GET", "https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/payment-methods/active");
      return response.json();
    },
    enabled: isOpen, // Only fetch when modal is open
  });
  ...
  const handleQRComplete = async () => {
    ...
    if (isTemporaryOrder) {
      ...
      try {
        ...
        const statusResponse = await fetch(`https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/orders/${orderInfo.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
          ...
          if (data.tableId) {
            ...
            try {
              ...
              if (ordersResponse.ok) {
                ...
                if (otherActiveOrders.length === 0) {
                  const tableUpdateResponse = await fetch(
                    `https://ae5ea441-9a81-4f0c-badc-1b445a58a294-00-bx7jg4f6rly0.sisko.replit.dev/api/tables/${data.tableId}/status`,
                    {
                      method: "PUT",
                      headers: {
                        "Content-Type": "application/json",
